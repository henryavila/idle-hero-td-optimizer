...
Short index of durable project learnings for future sessions.

- [Runtime portability](runtime-portability.md): keep shell launchers relocatable and handle stale port processes safely.
- [Optimizer input normalization](optimizer-input-normalization.md): preserve integer levels from Streamlit/Pandas and accept both decimal separators in resource inputs.
